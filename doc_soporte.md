![](RackMultipart20210414-4-1ti4g8a_html_d341307649ca1d39.png) ![](RackMultipart20210414-4-1ti4g8a_html_843172d6da6a52b1.png)
...
La siguiente tabla resume el período de recolección
# 1
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| A1-1 | Encuestado(a) | String |   |   | 86831 | 0 | Clave única que identifica al encuestado(a). Corresponde a un dato encriptado. |
| A1-2 | IdComuna | String |   |   | 86831 | 0 | Se mantiene formato String, considerando que el Id de Comuna puede contener en el inicio el valor &quot;0&quot; |
| A1-3 | Comuna | String |   |   | 86831 | 0 |   |
| A3-1 | Edad | Int |   |   | 86831 | 0 | Para el cálculo de la edad, se consideró la fecha de nacimiento reportada por el encuestado(a) respecto a la fecha de corte del estudio: 24-10-2020. Lo señalado responde a velar por el cumplimiento de la Ley 19628, SOBRE PROTECCION DE LA VIDA PRIVADA, evitando que el registro permita identificar al encuestado(a) |
| A4 | Peso Estimado | Int |   |   | 86810 | 21 | Expresado en kilógramos |
| A5 | Estatura estimada | Int |   |   | 86791 | 40 | Expresado en centímetros |
| A6 | Genero | Int |   | Prefiero no mencionar (opción utilizada mantener anonimato) = 1
 Masculino = 2
 Femenino = 3 | 86831 | 0 |   |

| Id | Identificación semántica de la pregunta | Formato | Condición lógica | Categorías | Registros que cumplen con validación | Missings | Nota |
| --- | --- | --- | --- | --- | --- | --- | --- |
| A7 | Por favor indique su profesión, técnico u oficio según lugar de atención: APS u Hospital | Int |   | MÉDICO = 1
 ENFERMERA/O = 2
 MATRÓN/A = 3
 TECNÓLOGO MÉDICO = 4
 KINESIÓLOGO/A = 5
 ...
 TENS = 8
 ODONTÓLOGO = 9
 QUÍMICO FARMACÉUTICO = 10
 PERSONAL AUXILIAR = 11
 CONDUCTOR O CHOFER = 12
 PERSONAL ADMINISTRATIVO = 13
 PERSONAL DE APOYO (ASEO, OTROS) = 14 | 86831 | 0 |   |
| A7-2 | Categoría APS u Hospital | Int |   | Hospital = 1
 APS = 2 | 86831 | 0 |   |
| A8 | Hospital: Seleccione a qué lugar de trabajo pertenece, considerando el que tiene su mayor tiempo de jornada laboral | Int |   | UNIDAD DE PACIENTES CRÍTICOS ADULTOS Y PEDIÁTRICOS = 1
...
| Id | Identificación semántica de la pregunta | Formato | Condición lógica | Categorías | Registros que cumplen con validación | Missings | Nota |
| --- | --- | --- | --- | --- | --- | --- | --- |
| B16 | En los momentos de descanso se ha reunido a fumar con otras personas dentro o fuera del establecimiento | Int |   | Siempre = 1
 En ocasiones = 2
 Nunca = 3 | 85529 | 0 |   |
| --- | --- | --- | --- | --- | --- | --- | --- |
| B17 | Ha compartido a menos de 1 metro de distancia con otras personas y sin mascarilla (comedor, oficina, zona de descanso, etc.) | Int |   | Siempre = 1
 En ocasiones = 2
 Nunca = 3 | 85529 | 0 |   |
| --- | --- | --- | --- | --- | --- | --- | --- |
| B18-1 | SÍNTOMAS Y/ ENFERMEDADES PRESENTES : Fiebre mayor a 38,5°C controlada con termómetro | Int |   | Sí = 1
 No = 2 | 85529 | 0 | El encuestado(a) tuvo la posibilidad se dejar sin respuesta la pregunta B18, en el caso que no presentara síntomas: 1712 casos |
| --- | --- | --- | --- | --- | --- | --- | --- |
| B18-2 | SÍNTOMAS Y/ ENFERMEDADES PRESENTES : Dolor de cabeza | Int |   | Sí = 1
 No = 2 | 85529 | 0 |
| B18-3 | SÍNTOMAS Y/ ENFERMEDADES PRESENTES : Dolor de garganta | Int |   | Sí = 1
 No = 2 | 85529 | 0 |
| B18-4 | SÍNTOMAS Y/ ENFERMEDADES PRESENTES : Tos | Int |   | Sí = 1
 No = 2 | 85529 | 0 |
| B18-5 | SÍNTOMAS Y/ ENFERMEDADES PRESENTES : Dificultad para respirar | Int |   | Sí = 1
 No = 2 | 85529 | 0 |
| B18-6 | SÍNTOMAS Y/ ENFERMEDADES PRESENTES : Dolor muscular | Int |   | Sí = 1
 No = 2 | 85529 | 0 |
| B18-7 | SÍNTOMAS Y/ ENFERMEDADES PRESENTES : Pérdida de olfato | Int |   | Sí = 1
 No = 2 | 85529 | 0 |
| B18-8 | SÍNTOMAS Y/ ENFERMEDADES PRESENTES : Pérdida del gusto | Int |   | Sí = 1
 No = 2 | 85529 | 0 |
| B18-9 | SÍNTOMAS Y/ ENFERMEDADES PRESENTES : Diarrea/ Vómitos/náuseas | Int |   | Sí = 1
 No = 2 | 85529 | 0 |
| B18-10 | SÍNTOMAS Y/ ENFERMEDADES PRESENTES : Ninguno | Int |   | Sí = 1
 No = 2 | 85529 | 0 |

| Id | Identificación semántica de la pregunta | Formato | Condición lógica | Categorías | Registros que cumplen con validación | Missings | Nota |
| --- | --- | --- | --- | --- | --- | --- | --- |
| B19-1 | Usted presenta alguna de estas enfermedades asociadas (deje en blanco si no presenta alguna de estas alternativas, y continúe con la siguiente pregunta): Diabetes mellitus | Int |   | Sí = 1
 No = 2 | 85529 | 0 | El encuestado(a) tuvo la posibilidad se dejar sin respuesta la pregunta B19, en el caso que no presentara enfermedades o riesgos: 3153 casos |
| --- | --- | --- | --- | --- | --- | --- | --- |
| B19-2 | Usted presenta alguna de estas enfermedades asociadas (deje en blanco si no presenta alguna de estas alternativas, y continúe con la siguiente pregunta): Hipertensión Arterial | Int |   | Sí = 1
 No = 2 | 85529 | 0 |
| B19-3 | Usted presenta alguna de estas enfermedades asociadas (deje en blanco si no presenta alguna de estas alternativas, y continúe con la siguiente pregunta): Enfermedad Pulmonar Obstructiva crónica | Int |   | Sí = 1
 No = 2 | 85529 | 0 |
| B19-4 | Usted presenta alguna de estas enfermedades asociadas (deje en blanco si no presenta alguna de estas alternativas, y continúe con la siguiente pregunta): Asma | Int |   | Sí = 1
 No = 2 | 85529 | 0 |
| B19-5 | Usted presenta alguna de estas enfermedades asociadas (deje en blanco si no presenta alguna de estas alternativas, y continúe con la siguiente pregunta): Diagnóstico de cáncer en últimos 5 años | Int |   | Sí = 1
 No = 2 | 85529 | 0 |
| B19-6 | Usted presenta alguna de estas enfermedades asociadas (deje en blanco si no presenta alguna de estas alternativas, y continúe con la siguiente pregunta): Estrés o trastornos de salud mental | Int |   | Sí = 1
 No = 2 | 85529 | 0 |
| B19-7 | Usted presenta alguna de estas enfermedades asociadas (deje en blanco si no presenta alguna de estas alternativas, y continúe con la siguiente pregunta): Consumo de tabaco en los últimos 5 años | Int |   | Sí = 1
 No = 2 | 85529 | 0 |
| B19-8 | Usted presenta alguna de estas enfermedades asociadas (deje en blanco si no presenta alguna de estas alternativas, y continúe con la siguiente pregunta): Ninguno | Int |   | Sí = 1
 No = 2 | 85529 | 0 |
...
| C5 | Resultado segundo PCR | Int | Depende de respuesta &quot;1&quot; en pregunta &quot;C1&quot; | Positivo = 1
